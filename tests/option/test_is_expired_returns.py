...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            datetime.strptime("2021-07-01 09:45:00.000000", "%Y-%m-%d %H:%M:%S.%f"),
            False,
        ),
        (
        ...
        (
            datetime.strptime("07-16-2021", "%m-%d-%Y"),
            datetime.strptime("2021-07-16 09:45:00.000000", "%Y-%m-%d %H:%M:%S.%f"),
            False,
        ),
        (
            datetime.strptime("07-16-2021", "%m-%d-%Y"),
            datetime.strptime("2021-07-16 16:14:00.000000", "%Y-%m-%d %H:%M:%S.%f"),
            False,
        ),
        (
            datetime.strptime("07-16-2021", "%m-%d-%Y"),
            datetime.strptime("2021-07-16 16:15:00.000000", "%Y-%m-%d %H:%M:%S.%f"),
            True,
        ),
        (
            datetime.strptime("07-16-2021", "%m-%d-%Y"),
...
def test_is_expired_returns_correct_result(
    call_option, ticker, put_option, expiration_date_test, quote_date, expected_result
):
