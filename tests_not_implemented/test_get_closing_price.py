...
@pytest.mark.parametrize("open_qty, expected_closing_price", [(1, 0.0), (-1, 0.05)])
def test_get_closing_price_on_call_option_when_bid_is_zero(
...
@pytest.mark.parametrize("open_qty, expected_closing_price", [(1, 0.0), (-1, 0.05)])
def test_get_closing_price_on_put_option_when_bid_is_zero(
    open_qty, expected_closing_price
):
